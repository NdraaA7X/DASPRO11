...
public class StudiKasus1 {
    ...
    public static void main(String[] args) {
        ...
        double potongan_dana_pensiun = 0.05, gaji_bersih, potongan_gaji, total_tunjangan, gaji_pokok_diterima;

        System.out.println("Gaji Pokok Yang Dimiliki Bu Jesi Adalah " + gaji_pokok);
        System.out.println("Tunjangan Per Anak " + tunjangan_anak);
       ...
       potongan_gaji = gaji_pokok * potongan_dana_pensiun;
